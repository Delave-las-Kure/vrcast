...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::deploy::ipc::server_detect,
            commands::deploy::ipc::dns_check,
            commands::deploy::ipc::deploy_plan,
            commands::deploy::ipc::deploy_run,
            commands::deploy::ipc::server_upgrade_plan,
            commands::deploy::ipc::server_upgrade_run,
            commands::deploy::ipc::server_rollback,
            commands::diag::ipc::diag_health,
